...
namespace OLC.Web.API.Controllers
{
    ...
    {
        string connectionString = "Data Source=104.243.32.43;Initial Catalog=dev_olc_db;Persist Security Info=True;User ID=olc_db_usr;Password=DubaiDutyFree@2025;Encrypt=False;";
        ...
        public async Task<IActionResult> AuthenticateUserAsync(UserAuthentication userAuthentication)
        {
            try
            {
                ...
                sqlCommand.Parameters.AddWithValue("@userName", userAuthentication.username);
        ...
        public async Task<IActionResult> GenarateUserClaimsAsync(AuthResponse authResponse)
        {
            try
            {
                ...
                sqlCommand.Parameters.AddWithValue("@userName", authResponse.Email);
