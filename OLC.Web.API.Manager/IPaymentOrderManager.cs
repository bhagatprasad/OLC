...
namespace OLC.Web.API.Manager
{
    public interface IPaymentOrderManager
    {
        ...
        Task<List<PaymentOrder>> GetPaymentOrderByIdAsync(long paymentOrderId);
        Task<List<ExecutivePaymentOrders>> GetOrdersForAutoApprovalAsync(long transactionFeeId);
        Task<List<PaymentOrder>> GetApprovedOrdersForDepositAsync();
    }
}
