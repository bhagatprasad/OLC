...
USING (
    ...
    FROM (
        VALUES 
            ...
            ('India', 'Telangana', 'Hyderabad', 'Hyd'),
            ('India', 'Telangana', 'Karimnagar', 'KRMR'),
            ('India', 'Telangana', 'Warangal', 'WL'),
            ('India', 'Telangana', 'Nizambad', 'NZ'),
            ('India', 'Telangana', 'Adilabad', 'AD'),
            ('India', 'Telangana', 'Rangareddy', 'RR'),
            ('India', 'Telangana', 'Nalgonda', 'NL'),
            ('India', 'Telangana', 'Khammam', 'KMM'),
            -- United States
